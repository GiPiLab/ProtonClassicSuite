...
void ProtonClassicSuiteUnitTests::testCaseForAuditManagement() {
  ...
  QList<int> years = {2010, 2011, 2012, 2013};
...
void ProtonClassicSuiteUnitTests::testCaseForNumbersConversion() {
  ...
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(MAX_NUM * 1000)),
           (double)MAX_NUM * 1000);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(MAX_NUM * 10000)),
           (double)MAX_NUM * 10000);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(MAX_NUM * 100000)),
           (double)MAX_NUM * 100000);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(MAX_NUM * 1000000)),
           (double)MAX_NUM * 1000000);

  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(-MAX_NUM)), (double)-MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(-MAX_NUM * 10)), (double)-MAX_NUM * 10);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(-MAX_NUM * 100)),
           (double)-MAX_NUM * 100);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(-MAX_NUM * 1000)),
           (double)-MAX_NUM * 1000);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(NUMBERSFORMAT::doubleToFixedPoint(-MAX_NUM * 10000)),
  ...
  QCOMPARE(NUMBERSFORMAT::doubleToFixedPoint(NUMBERSFORMAT::fixedPointToDouble(MAX_NUM * 10000000)),
           MAX_NUM * 10000000);
  ...
  QCOMPARE(NUMBERSFORMAT::doubleToFixedPoint(NUMBERSFORMAT::fixedPointToDouble(-MAX_NUM * 10000)), -MAX_NUM * 10000);
  QCOMPARE(NUMBERSFORMAT::doubleToFixedPoint(NUMBERSFORMAT::fixedPointToDouble(-MAX_NUM * 100000)), -MAX_NUM * 100000);
  QCOMPARE(NUMBERSFORMAT::doubleToFixedPoint(NUMBERSFORMAT::fixedPointToDouble(-MAX_NUM * 1000000)),
           -MAX_NUM * 1000000);
  QCOMPARE(NUMBERSFORMAT::doubleToFixedPoint(NUMBERSFORMAT::fixedPointToDouble(-MAX_NUM * 10000000)),
           -MAX_NUM * 10000000);
}
...
void ProtonClassicSuiteUnitTests::testCaseForAuditNodes() {
  ...
  tree.finishTree();
  unsigned int auditId = PCx_Audit::addNewAudit("RANDOMAUDIT", QList<int>{2010, 2011}, treeId);

  PCx_Audit audit(auditId);
  for (unsigned int i = static_cast<unsigned int>(MODES::DFRFDIRI::DF); i < sizeof(MODES::DFRFDIRI); i++) {
  ...
  audit.setLeafValues(firstLeaf, MODES::DFRFDIRI::DF, 2010,
                      QMap<PCx_Audit::ORED, double>{{PCx_Audit::ORED::OUVERTS, 100.4},
                                                    {PCx_Audit::ORED::REALISES, 50.3},
                                                    {PCx_Audit::ORED::ENGAGES, 10.0}});
  audit.setLeafValues(lastLeaf, MODES::DFRFDIRI::DF, 2010,
                      QMap<PCx_Audit::ORED, double>{{PCx_Audit::ORED::OUVERTS, 200.6},
                                                    {PCx_Audit::ORED::REALISES, 60.2},
                                                    {PCx_Audit::ORED::ENGAGES, 20.0}});

  audit.setLeafValues(firstLeaf, MODES::DFRFDIRI::DF, 2011,
                      QMap<PCx_Audit::ORED, double>{{PCx_Audit::ORED::OUVERTS, (double)MAX_NUM},
                                                    {PCx_Audit::ORED::REALISES, (double)MAX_NUM},
                                                    {PCx_Audit::ORED::ENGAGES, (double)MAX_NUM}});
  audit.setLeafValues(lastLeaf, MODES::DFRFDIRI::DF, 2011,
                      QMap<PCx_Audit::ORED, double>{{PCx_Audit::ORED::OUVERTS, (double)-MAX_NUM},
                                                    {PCx_Audit::ORED::REALISES, (double)-MAX_NUM},
                                                    {PCx_Audit::ORED::ENGAGES, (double)-MAX_NUM}});

  // Test correct set and get
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::OUVERTS, 2010)),
           100.4);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::REALISES, 2010)),
           50.3);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::ENGAGES, 2010)),
           10.0);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::OUVERTS, 2011)),
           (double)MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(lastLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::OUVERTS, 2011)),
           (double)-MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::REALISES, 2011)),
           (double)MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(lastLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::REALISES, 2011)),
           (double)-MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::ENGAGES, 2011)),
           (double)MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(lastLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::ENGAGES, 2011)),
           (double)-MAX_NUM);

  // Test disponible computation
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::DISPONIBLES, 2010)),
           100.4 - (50.3 + 10.0));
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(firstLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::DISPONIBLES, 2011)),
           (double)-MAX_NUM);
  QCOMPARE(NUMBERSFORMAT::fixedPointToDouble(
               audit.getNodeValue(lastLeaf, MODES::DFRFDIRI::DF, PCx_Audit::ORED::DISPONIBLES, 2011)),
           (double)MAX_NUM);
  // Test propagation to the root
  QCOMPARE(
      NUMBERSFORMAT::fixedPointToDouble(audit.getNodeValue(1, MODES::DFRFDIRI::DF, PCx_Audit::ORED::OUVERTS, 2010)),
      100.4 + 200.6);
  QCOMPARE(
      NUMBERSFORMAT::fixedPointToDouble(audit.getNodeValue(1, MODES::DFRFDIRI::DF, PCx_Audit::ORED::REALISES, 2010)),
      50.3 + 60.2);
  QCOMPARE(
      NUMBERSFORMAT::fixedPointToDouble(audit.getNodeValue(1, MODES::DFRFDIRI::DF, PCx_Audit::ORED::ENGAGES, 2010)),
      30.0);
  QCOMPARE(
      NUMBERSFORMAT::fixedPointToDouble(audit.getNodeValue(1, MODES::DFRFDIRI::DF, PCx_Audit::ORED::DISPONIBLES, 2010)),
      160.5);

  QCOMPARE(
      NUMBERSFORMAT::fixedPointToDouble(audit.getNodeValue(1, MODES::DFRFDIRI::DF, PCx_Audit::ORED::OUVERTS, 2011)),
      0.0);
  QCOMPARE(
      NUMBERSFORMAT::fixedPointToDouble(audit.getNodeValue(1, MODES::DFRFDIRI::DF, PCx_Audit::ORED::DISPONIBLES, 2011)),
      0.0);
...
void ProtonClassicSuiteUnitTests::testCaseForAuditDuplication() {
  ...
  unsigned int dupAuditId = audit.duplicateAudit("DUPAUDIT", QList<int>{2009, 2010, 2011, 2012});
...
void ProtonClassicSuiteUnitTests::testCaseForAuditImportExport() {
  ...
  tree.finishTree();
  unsigned int auditId = PCx_Audit::addNewAudit("RANDOMAUDIT", QList<int>{2010, 2011}, treeId);
  unsigned int importedAuditId = PCx_Audit::addNewAudit("IMPORTEDAUDIT", QList<int>{2010, 2011}, treeId);

  PCx_Audit audit(auditId);
  PCx_Audit importedAudit(importedAuditId);

  QString tmpFileNameSkel1 =
      QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/" + generateUniqueFileName(".xlsx");
  ...
  QString tmpFileNameDF =
      QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/" + generateUniqueFileName(".xlsx");
  QString tmpFileNameRF =
      QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/" + generateUniqueFileName(".xlsx");
  QString tmpFileNameDI =
      QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/" + generateUniqueFileName(".xlsx");
  QString tmpFileNameRI =
      QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/" + generateUniqueFileName(".xlsx");
