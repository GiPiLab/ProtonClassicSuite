...
/**
 * @brief The PCx_Query class is the base class for predefined queries for an
 * audit
 */
class PCx_Query {
public:
  ...
  PCx_Query(PCx_Audit *model, unsigned int typeId, PCx_Audit::ORED ored, MODES::DFRFDIRI dfrfdiri, int year1, int year2,
            QString name = "");

  virtual ~PCx_Query() = default;

  QPair<int, int> getYears() const { return QPair<int, int>(year1, year2); }
  virtual void setYears(int year1, int year2);
