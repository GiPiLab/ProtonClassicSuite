...
public:
  explicit FormAuditTreemap(QWidget *parent = nullptr);
  ~FormAuditTreemap();
...
private slots:
  ...
  void on_treeMapWidget_clicked(const QString &name, unsigned int id, int year, double value);

  void on_treeMapWidget_highlighted(const QString &name, unsigned int id, int year, double value);
