...
public:
  explicit FormQueries(QWidget *parent = nullptr);
  ~FormQueries();
...
private:
  ...
  bool getParamsReqVariation(unsigned int &typeId, PCx_Audit::ORED &ored, MODES::DFRFDIRI &dfrfdiri,
                             ...
                             PCx_QueryVariation::PERCENTORPOINTS &percent, PCx_QueryVariation::OPERATORS &oper,
                             qint64 &val, int &year1, int &year2);
  QString execQueries(QModelIndexList items, QXlsx::Document *xlsDocument = nullptr);
  bool getParamsReqRank(unsigned int &typeId, PCx_Audit::ORED &ored, MODES::DFRFDIRI &dfrfdiri, unsigned int &number,
                        PCx_QueryRank::GREATERSMALLER &grSm, int &year1, int &year2);
  bool getParamsReqMinMax(unsigned int &typeId, PCx_Audit::ORED &ored, MODES::DFRFDIRI &dfrfdiri, qint64 &val1,
                          qint64 &val2, int &year1, int &year2);
};
